            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center bg-primary">
                        <h5 class="mb-0 text-white">Add Booking</h5>
                        <div class="btn-group">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" name="quote_price"
                                    value="{{ old('quote_price') }}" class="form-control" required>
                                @error('quote_price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" name="booking_price"
                                    value="{{ old('booking_price') }}" class="form-control">
                                @error('booking_price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" name="advance_paid"
                                    value="{{ old('advance_paid') }}" class="form-control">
                                @error('advance_paid')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
@section('extra_js')
    <script>
        $(document).ready(function() {
            ...
            // Set min date for start_datetime as today
            ...
            // When start_datetime changes, set end_datetime min
            startInput.on('change', function() {
                const startVal = new Date($(this).val());
                if (!isNaN(startVal)) {
                    endInput.attr('min', formatDateTimeLocal(startVal));
                    // If current end is before start, reset it
